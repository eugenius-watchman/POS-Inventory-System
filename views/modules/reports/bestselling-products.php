...
$salesTotal = ControlProducts::ctrShowAddingOfTheSales();
...
<h3 class="box-title">Bestselling products</h3>
...
for ($i = 0; $i < 10; $i++) {
    echo ' <li><i class="fa fa-circle-o text-' . $colours[$i] . '"></i> '
    . $products[$i]['description'] . '</li>';
}
