...
foreach ($products as $key => $value) {
    ...
    $category = ControlCategories::ctrShowCategories($item, $value);
...
<input type="text" class="form-control input-lg" name="newCode"
...
name="newBuyingPrice" min="0" placeholder="Buying Price" required>
...
<input type="number" class="form-control input-lg"
name="newSalePrice" min="0" placeholder="Sale Price" required>
