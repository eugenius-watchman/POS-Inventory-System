...
pos/ ├── controllers/ # Controller layer - Business logic │ ├── categories.controller.php │ ├── clients.controller.php │ ├── products.controller.php │ ├── sales.controller.php │ └── users.controller.php ├── models/ # Model layer - Data handling │ ├── categories.model.php │ ├── clients.model.php │ ├── products.model.php │ ├── sales.model.php │ └── users.model.php ├── views/ # View layer - Presentation │ ├── modules/ # Various application modules │ ├── js/ # JavaScript files │ └── img/ # Images and assets ├── ajax/ # AJAX handlers for async operations └── extensions/ # Third-party libraries (TCPDF, etc.)
🔄 MVC Flow

    Model: Handles data operations and database interactions
    View: Presents data to users and collects user input
...
```bash
>>>>>>> 818af7d84ef66d5ebf4b05b1587cd6d5337a98aa
