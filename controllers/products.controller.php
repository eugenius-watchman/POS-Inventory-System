        ...
        if (isset($_POST['newDescription'])) {
            if (preg_match('/^[a-zA-Z0-9- ]+$/', $_POST['newDescription']) &&
                ...
                if (isset($_FILES['newImage']['error'])) {
                    // Check if upload was successful and file exists
                    if ($_FILES['newImage']['error'] === UPLOAD_ERR_OK && 
                        file_exists($_FILES['newImage']['tmp_name'])) {
                        ...
                        if (in_array($fileType, $allowedTypes)) {
                            ...
                            /* CREATE FOLDER FOR PRODUCT IMAGE */
                            ...
                            $imageRoute = "views/img/products/".$_POST["newCode"]."/".$randomNum.".$extension";
                            ...
                            if ($fileType === 'image/jpeg') {
                                imagejpeg($destination, $imageRoute, 90); // 90% quality
                            } else {
                                imagepng($destination, $imageRoute, 9); // 9 compression level
                            }
