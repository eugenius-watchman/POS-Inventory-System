...
// Adjusting block widths and table widths for smaller paper
$block1 = <<<EOF
<table>
    <tr>
        <td style="width:70px"><img src="images/logo-negro-bloque.png" style="width:55px;"></td>
        <td style="background-color:white; width:50px; font-size:6px;">
            BINARY STUDIOS<br>
            Addr: Adenta,Accra
        </td>
        <td style="background-color:white; width:50px; font-size:6px;">
        ...
        <td style="background-color:white; width:40px; text-align:center; color:red; font-size:6px;">
            BILL No.<br>$valueSale
        </td>
    </tr>
</table>
<br>
...
<table>
    <tr>
        <td style="width:70px"><img src="images/back.jpg" style="width:50px;"></td>
    </tr>
</table>
...
<table style="font-size:8px; padding:3px;">
    ...
    <tr>
        <td style="border: 1px solid #666; background-color:white; width:210px">Seller: $replySeller[name]</td>
    </tr>
</table>
<br>
<br>
...
<table style="font-size:8px; padding:3px;">
    <tr>
        <td style="border: 1px solid #666; background-color:white; width:80px; text-align:center">Product</td>
        <td style="border: 1px solid #666; background-color:white; width:30px; text-align:center">Qty</td>
        <td style="border: 1px solid #666; background-color:white; width:50px; text-align:center">Unit</td>
        <td style="border: 1px solid #666; background-color:white; width:50px; text-align:center">Total</td>
    </tr>
</table>
EOF;
...
$pdf->SetFont('dejavusans', '', 8); // works on cedi sign
...
<table style="font-size:8px; padding:3px;">
    <tr>
        <td style="color:#333; background-color:white; width:110px; text-align:center"></td>
        <td style="border: 1px solid #666; background-color:white; width:50px; text-align:center">Net:</td>
        <td style="border: 1px solid #666; color:#333; background-color:white; width:50px; text-align:center">
            GH₵ $net
        </td>
    </tr>
    <tr>
        <td style="color:#333; background-color:white; width:110px; text-align:center"></td>
        <td style="border: 1px solid #666; background-color:white; width:50px; text-align:center">Tax:</td>
        <td style="border: 1px solid #666; color:#333; background-color:white; width:50px; text-align:center">
            GH₵ $tax
        </td>
    </tr>
